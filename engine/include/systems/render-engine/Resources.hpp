...
//	static shared_ptr<Entity> objectFromGLTFNode(const std::string& idPrefix, const tinygltf::Node& node, const tinygltf::Model& model);
};
...
//	}
//
//	Resources::meshes[key] = std::make_shared<T>(std::forward<Args>(args) ...);
